<template>
    <div class=" flex items-center justify-center dark:bg-gray-900">
        <div class="w-full max-w-lg mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg">
            <!-- Sign in with options -->
            <div class="">
                <h3 class="text-center text-xl font-semibold text-gray-700 dark:text-white mb-2">Or Sign in With</h3>
                <hr>
                <div class="flex flex-wrap justify-center gap-2 mt-2"> <!-- Reduced the gap between buttons -->
                    <!-- Google Button -->
                    <button type="button"
